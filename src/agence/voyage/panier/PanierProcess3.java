...
@WebServlet("/PanierProcess3")
public class PanierProcess3 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
 
    public PanierProcess3() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(log.equals("Confirmer") && z!=null && z.getDestination()!=null) {
	    	...
	    	request.getRequestDispatcher("testingPro.jsp").forward(request, response);
				...
				request.getRequestDispatcher("Croissiére.jsp").forward(request,response);
			}
	}
