...
@WebServlet("/PanierProcess4")
public class PanierProcess4 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public PanierProcess4() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(log.equals("Confirmer") && z!=null && z.getDestination()!=null) {
	    	...
	    	request.getRequestDispatcher("testingPro.jsp").forward(request, response);
				...
				request.getRequestDispatcher("neige.jsp").forward(request,response);
			}
	}
