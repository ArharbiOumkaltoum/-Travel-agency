...
@WebServlet("/PanierProcess")
public class PanierProcess extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public PanierProcess() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(log.equals("Confirmer") && z!=null && z.getDestination()!=null) {
	    	...
	    	request.getRequestDispatcher("testingPro.jsp").forward(request, response);
				...
				request.getRequestDispatcher("Randonné.jsp").forward(request,response);
			}
