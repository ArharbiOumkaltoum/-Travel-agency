...
<body>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text text-center">
                        <h3>${message} Bienvenue a Votre Espace Client !!</</h3>
                        <p></p>
                    </div>
                </div>
            </div>
    ...
    <h2 align="center"><font><strong>Bon plan Voyages: partez où vous voulez jusqu’à -50% grâce à FRIENDS Voyages</strong></font></h2> 
  <h3>Code de promotion pour cette semaine est : 197658</h3>
    <!--/ bradcam_area  -->
    </body>
    <footer class="footer">
