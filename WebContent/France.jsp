            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-9">
                    <div class="destination_info">
                        <h3>Description</h3>
                        <p>Premier parc national français, la Vanoise est un havre de paix et de nature où prospèrent faune et flore. Cet itinéraire de randonnée passe par les plus beaux balcons, avec des points de vue magnifiques sur plusieurs dômes recouverts de glaciers. Edelweiss, marmottes et bouquetins sont au rendez-vous.</p>
                        <div class="single_destination">
                            <h4>Jour-01</h4>
                            <p>Rendez-vous à 8 h à l'aéroport. Transfert en navette privative jusqu'au refuge du Plan du Lac (2364 m), au cœur du parc national de la Vanoise. Depuis le refuge, vous suivez le célèbre GR5 qui remonte dans le vallon de la Leisse. Au pont de Croé-Vie (2099 m), le sentier bifurque en direction du col de la Vanoise (2517 m). Le cheminement le long des lacs offre de magnifiques contrastes paysagers et une flore épanouie. Vous passez près du refuge du Col de la Vanoise (2516 m), puis vous entamez la descente jusqu'à Pralognan-la-Vanoise. Court transfert en bus local pour rejoindre le parking des Prioux, et le refuge où nous passerons la nuit..</p>
                        </div>
                        <div class="single_destination">
                            <h4>Jour-02</h4>
                            <p>Remontée du vallon de Chavière pour rejoindre le refuge de Péclet-Polset (2474 m). Puis, vous atteignez le col de Chavière (2796 m), petite échancrure dans la crête entre le domaine de Péclet-Polset et la pointe de l'Echelle, cimes glaciaires. Descente sur le refuge de l'Orgère (1935 m). </p>
                        </div>
                         <div class="single_destination">
                            <h4>Jour-03</h4>
                            <p>Remontée du vallon de Chavière pour rejoindre le refuge de Péclet-Polset (2474 m). Puis, vous atteignez le col de Chavière (2796 m), petite échancrure dans la crête entre le domaine de Péclet-Polset et la pointe de l'Echelle, cimes glaciaires. Descente sur le refuge de l'Orgère (1935 m). </p>
                         ...
                         <div class="single_destination">
                            <h4>Jour-04</h4>
                            <p>Dernière étape, qui clôture le tour des glaciers de la Vanoise. Une randonnée en balcon du refuge de la dent Parrachée à celui de plan Sec (2316 m), puis jusqu’aux ruines de la Turra (2360 m) et la croix de la Loza (2377 m). Enfin, vous atteignez Montafia (2180 m), point de départ de la descente finale jusqu’à Termignon (1287 m). Fin de séjour vers 17 h 30. </p>
                     </div>
