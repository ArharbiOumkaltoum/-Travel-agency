...
<body>
          ...
          <div class="row">
              <div class="col-xl-12">
                  <div class="bradcam_text text-center">
                      <h3>Chercher votre voyage ICI</h3>
                  </div>
              </div>
          </div>
      </div>
  ...
  <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Voyage Disponible</h2>
                    </div>
                    <div class="col-lg-8">
                        <form  action="MatchV" method="post">
                            <div class="row">
                             <div class="col-12">
                                   <div><h3>${msg}</h3></div>
                                <div class="col-12">
                                 ...
                                 <div class="col-12">
                                    <div class="form-group">
                                         <input class="form-control valid" name="destination"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Votre Destination'" placeholder="Votre Destination" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                         <input class="form-control valid" name="Datedepart"  type="date" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Quand voulez vous voyager?'" placeholder="Quand voulez vous voyager?" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                         <input class="form-control valid" name="budget"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Quel est votre budget?'" placeholder="Quel est votre budget?" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                            ...
                            <div class="form-group mt-3">
                                <input class="boxed-btn4 " name="login"  type="submit"  value="Chercher">
                            </div>
                        </form>
  <!-- ------------ -->
