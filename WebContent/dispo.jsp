...
<body>
    ...
    <header>
      ...
      <!-- bradcam_area  -->
     <div class="bradcam_area bradcam_bg_21">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text text-center">
                        <h3>Bienvenue a le voyage numero${msg}</h3>
                        <p></p>
                    </div>
                </div>
            </div>
...
<%
String id = request.getParameter("id_vol");
...
<h2 align="center"><font><strong>Voilà des voyages de même promotion que le voyage que vous avez choisi Promotion -50% :</strong></font></h2>
<h1>Code de promotion pour votre voyage: 197658</h1>
	<table align="center" cellpadding="12" cellspacing="12" border="1">

<tr bgcolor="#A52A2A">
    <td><b>numéro_voyage</b></td>
	<td><b>type_voyage</b></td>
	<td><b>destination</b></td>
	<td><b>activité</b></td>
	<td><b>date_depart</b></td>
	<td><b>durée</b></td>
	<td><b>prix</b></td>
	<td><b>lieu_depart</b></td>
	<td><b>moyen_voyage</b></td>
	<td><b>nom_hotel</b></td>
	<td><b>adresse_hotel</b></td>
	<td><b>nombre_etoile</b></td>
...
%>
<tr bgcolor="#DEB887">
	    <td><%=resultSet.getString("id_vol") %></td>
		<td><%=resultSet.getString("type_voyage") %></td>
		<td><%=resultSet.getString("destination") %></td>
		<td><%=resultSet.getString("activite") %></td>
		<td><%=resultSet.getString("date_depart") %></td>
		<td><%=resultSet.getString("duree") %></td>
	    <td><%=resultSet.getString("prix") %></td>
		<td><%=resultSet.getString("lieu_depart") %></td>
		<td><%=resultSet.getString("moyen_voyage") %></td>
		<td><%=resultSet.getString("nom_hot") %></td>
		<td><%=resultSet.getString("adress_hot") %></td>
		<td><%=resultSet.getString("nbr_etoile") %></td>
