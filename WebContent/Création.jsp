...
<body>
 ...
 <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Rejoignons-Nous</h2>
                    </div>
                    <div class="col-lg-8">
                        <form   action="ContactProcess"  method="post" name="inscription" >
                          <div class="row">
                            <div class="col-12" >
                                <div class="col-12">
                                    <div class="form-group">

                                        <input class="form-control valid" name="CIN"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'CIN...'" placeholder="CIN..." required>
                                    </div>
                                </div>
                                <div class="col-12">
                                  <div class="form-group">
                                        <input class="form-control valid" name="Nom"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nom...'" placeholder="Nom..." required>
                                </div>
                              </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control valid" name="Prenom"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Prénom...'" placeholder="Prénom..." required>
                                    </div>
                               
                              </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control valid" name="Email"  type="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email...'" placeholder="Email..."required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                         <input class="form-control valid" name="MotPass"  type="password" id="myInput" onfocus="this.placeholder = 'mot de passe'" onblur="this.placeholder = '***********'" placeholder="***********" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
							  ...
							  <p id="length" class="invalid">8 caractères au minimum </p>
                        </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                         <input class="form-control valid" name="Confirmation"  type="password" id="myVer"  onfocus="this.placeholder = 'confirmation de mot de passe'" onblur="this.placeholder = '***********'" placeholder="***********" required>
                                    </div>
                                </div>
                              
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control valid" name="Pays"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Pays...'" placeholder="Pays..." onclick="verfication()" required>
                                    </div>
                                </div>
                             </div>
                            </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input class="boxed-btn4 " name="sub" type="submit"  value="S'inscrire" >
                            </div>
                        </form>
...
<!--     
  ...
  if (x.type === "password") {
   ...
   function verfication() {
	   var error;
	   var x = document.getElementById("myInput");
	   var y= document.getElementById("myVer");
	   if (x.value != y.value) {
