                    ...
                    <div class="row">
                        <div class="col-lg-11 offset-lg-1">
                            <div class="story_info">
                                <div class="row">
                                    <div class="col-lg-9">
                                        <p>FRIENDS est une agence de voyage marocainne du secteur touristique, originellement créée vers le milieu du 2019 en Maroc par deux jeunes étudiantes du domaine informatique.</p>
                                        <p>L'agence compte environ 2 600 sous-agences de voyages, 33 voyagistes, une présence à travers 15 pays dans le monde et 89 avions.</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-md-6">
                                        <div class="thumb padd_1">
                                            <img src="img/about/deep.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="thumb">
                                            <img src="img/about/bella.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4">
                                        <div class="single_counter text-center">
                                            <h3  class="counter">3785</h3>
                                            <p>Tournée a réussi</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        <div class="single_counter text-center">
