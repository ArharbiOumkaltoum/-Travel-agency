...
<body>
    ...
    <section class="sample-text-area">
		<div class="container box_1170">
			<h3 class="text-heading">Pourqoui L'Amerique</h3>
			<p class="sample-text">
		     Les paysages sont simplement magnifiques, et complètement différents, que vous soyez dans les collines d’Antioquia, les iles Galapagos, le désert du Pérou ou dans l’Amazonie ! Les transports locaux, systèmes d’autobus, métros, etc., sont aussi très abordables. Il commence même à y avoir des vols ultra low-cost pour les déplacements en avion à l’intérieur même des pays, qui restaient encore très dispendieux sinon jusqu’ a récemment.
			</p>
		</div>
	</section>
				...
				<div class="progress-table-wrap">
					<div class="progress-table">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/mexic.jpg" alt="flag">Mexique</div>
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/argt.png" alt="flag">Argentine</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/canada.png" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/chili.png" alt="flag">Chili</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/dominic.png" alt="flag">Dominique</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/parag.png" alt="flag">Paraguay</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/saint.png" alt="flag">Sainte-Lucie</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/panama.png" alt="flag">Panama</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
									<div class="progress-bar color-7" role="progressbar" style="width: 30%"
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/venz.png" alt="flag">Venezuela</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
