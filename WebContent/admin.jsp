...
<body>
    ...
    <header>
     ...
     <div class="col-lg-12">
           ...
           <a href="ajoute.jsp">
          <input class="boxed-btn4" type="submit" value="Ajouter un voyage"> </a>
           </div>
     </div>
     </br>
     <div class="col-lg-12">
           <div class="submit_btn">
            <a href="supprimation.jsp">
           <input class="boxed-btn4" type="submit" value="Supprimer  un voyage"></a>
           </div>
     </div>
      ...
      <div class="col-lg-12">
           <div class="submit_btn">
           <a href="addpromotion.jsp">
           <input class="boxed-btn4" type="submit" value="Ajouter une promotion"></a>
           </div>
     </div>
     </br>
     <div class="col-lg-12">
           <div class="submit_btn">
           <a href="email.jsp">
           <input class="boxed-btn4" type="submit" value="boite d'email"></a>
           </div>
     </div>
     </br>
