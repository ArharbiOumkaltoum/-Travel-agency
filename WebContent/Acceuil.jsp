                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
                                ...
                                <a href="asie.jsp" class="boxed-btn3">Explorez maintenant</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
                                ...
                                <a href="elements.jsp" class="boxed-btn3">Explorez maintenant</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
                                ...
                                <a href="africa.jsp" class="boxed-btn3">Explorez maintenant</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="where_togo_area">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-3">
                    <div class="form_area">
                        <h3>Ici vous pouvez trouver des voyages de rêves</h3>
                    </div>
                </div>
                <div class="col-lg-9">
                    <div class="search_wrap">
                            ...
                            <div class="search_btn">
                                <a href="single-blog.jsp">
                                  <button class="boxed-btn4 " type="submit" >Chercher un voyage</button></a>          
                            </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb_70">
                        <h3>Les Destinations Les Plus Populaires</h3>
                        <p>Un homme voyage pour sentir et pour vivre. A mesure qu'il voit du pays, c'est lui-même qui vaut mieux la peine d'être vu.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="img/destination/pm.jpg" alt="">
                        </div>
                        <div class="content">
                            <p class="d-flex align-items-center">Maroc </p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="img/destination/fr.jpg" alt="">
                        </div>
                        <div class="content">
                            <p class="d-flex align-items-center">France</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="img/destination/eg.jpg" alt="">
                        </div>
                        <div class="content">
                            <p class="d-flex align-items-center">Egypte </p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="img/destination/tr.jpg" alt="">
                        </div>
                        <div class="content">
                            <p class="d-flex align-items-center">Turkey </p>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5">
                            <div class="newsletter_text">
                                <h4>Identifier , Et Commencer Votre Aventure Avec Nous!!!</h4>
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="newsletter_btn">
                                           <a href="contactClient.jsp">
                                            <button class="boxed-btn4 " type="submit" >Identifier</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        <div class="author_thumb">
                                            <img src="img/testmonial/tgh.jpg" alt="">
                                        </div>
                                        <div class="testmonial_author">
                                            <h3>Taghazout, Maroc.</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single_carousel">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        <div class="author_thumb">
                                            <img src="img/testmonial/frr.jpg" alt="">
                                        </div>
                        ...
                        <div class="single_carousel">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        <div class="author_thumb">
                                            <img src="img/testmonial/gt.jpg" alt="">
                                        </div>
                        ...
                        <div class="single_carousel">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        <div class="author_thumb">
                                            <img src="img/testmonial/is1.jpg" alt="">
                                        </div>
                                       
                                        <div class="testmonial_author">
                                            <h3>Istanbul, Turkie.</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single_carousel">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        <div class="author_thumb">
                                            <img src="img/testmonial/6.png" alt="">
                                        </div>
                                       
                                        <div class="testmonial_author">
                                            <h3>Saintmartine Iceland, America.</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single_carousel">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        <div class="author_thumb">
                                            <img src="img/testmonial/kec.jpg" alt="">
                                        </div>
                                        <div class="testmonial_author">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        ...
                                        <p>"Notre vie est un voyage constant, de la naissance à la mort. Le paysage change, les gens changent, les besoins se transforment, mais le train continue. La vie, c'est le train, ce n'est pas la gare."</p>
                                        <div class="testmonial_author">
                                            <h3>-Paulo Coelhoe</h3>
                                        </div>
                                    </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        ...
                                        <p>"Voyager est fatal aux préjugés, à l'intolérance et à l'étroitesse d'esprit.."</p>
                                        <div class="testmonial_author">
                                            <h3>-Mark Twain</h3>
                                        </div>
                                    </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        ...
                                        <p>"Voyager rend modeste. On voit mieux la place minuscule que l'on occupe dans le monde."</p>
                                        <div class="testmonial_author">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_trip">
                        ...
                        <div class="info">
                            ...
                            <a href="#">
                                <h3>Investir dans les voyages, c'est investir en soi-même
                                    c'est investir en soi-même</h3>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 col-md-6 col-lg-2">
                        <div class="footer_widget">
                            ...
                            <ul class="links">
                                <li><a href="nous">Qui somme-nous</a></li>
