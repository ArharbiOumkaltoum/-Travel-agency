...
<body>
    ...
    <section class="sample-text-area">
		<div class="container box_1170">
			<h3 class="text-heading">Pourqoui L'Europe</h3>
			<p class="sample-text">
			L’Europe est une destination idéale en été comme en hiver, car elle profite d’une facilité d’accès de toute part, mais aussi parce que c’est un continent à part entière. Voyager en Europe c’est aussi parce que cela ne coute pas trop cher, lorsque je choisis de voyager par exemple et que je n’ai un gros budget pour mes vacances, je choisis une destination en Europe, car cela coute moins cher et aussi parce que j’habite en France, cela me facilite bien des choses.
			</p>
		</div>
	</section>
				...
				<div class="progress-table-wrap">
					<div class="progress-table">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/france.jpg" alt="flag">France</div>
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/sweden.png" alt="flag">Suede</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/danemarc.png" alt="flag">Danemark</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/chili.png" alt="flag">Espagne</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/portugal.jpg" alt="flag">Portugal</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/lithuania.png" alt="flag">Lituanie</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/bulgaria.jpg" alt="flag">Bulgarie</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/finland.png" alt="flag">Finlande</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
									<div class="progress-bar color-7" role="progressbar" style="width: 30%"
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/croatia.png" alt="flag">Croatie</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
				...
				<div class="row gallery-item">
					...
					<div class="col-md-4">
						<a href="img/elements/g2.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(img/elements/pink.jpg);"></div>
						</a>
					</div>
					<div class="col-md-4">
						<a href="img/elements/g3.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(img/elements/maison.jpg);"></div>
						</a>
					</div>
					<div class="col-md-6">
						<a href="img/elements/g4.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(img/elements/blue.jpg);"></div>
						</a>
					</div>
					<div class="col-md-6">
						<a href="img/elements/g5.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(img/elements/paris.jpg);"></div>
						</a>
					</div>
					<div class="col-md-4">
						<a href="img/elements/g6.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(img/elements/rout.jpg);"></div>
						</a>
					</div>
					<div class="col-md-4">
						<a href="img/elements/g6.jpg" class="img-pop-up">
					...
					<div class="col-md-4">
						<a href="img/elements/g6.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(img/elements/l.jpg);"></div>
						</a>
					</div>
