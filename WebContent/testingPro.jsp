...
<body>
    ...
    <div class="row">
                    <div class="col-12">
                       <h3>${confir}</h3></div>
                        <h2 class="contact-title">Avez-vous un code de Promotion ?</h2>
                    </div>
                        <div class="col-lg-3 col-md-4">
                                        <div class="newsletter_btn">
                                           <a href="achatPro.jsp">
                                            <button class="boxed-btn4 " type="submit" >Oui</button></a>
                                             <a href="achat.jsp">
                                            <button class="boxed-btn4 " type="submit" >Non</button></a>
                                        </div>
                                    </div>
