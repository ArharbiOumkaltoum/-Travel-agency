...
<body>
    ...
    <section class="sample-text-area">
		<div class="container box_1170">
			<h3 class="text-heading">Pourqoui L'Asie</h3>
			<p class="sample-text">
			 Les paysages… C’est du rêve permanent en Asie, ou presque. Il fallait se retenir pour ne pas rester la gueule béante en permanence, car tout de même, ça en jette. Et puis cela fait un bien fou de voir des paysages différents de ce dont on a l’habitude. 
             J’ai personnellement été fan de l’Indonésie. Entre les volcans magnifiques, la végétation luxuriante et les plages de rêve, j’étais servi. Ce qui m’a réellement coupé le souffle c’est le lever de soleil vers 4-5h du matin sur le volcan Merapi.
             Arrive près du sommet après quelques heures d’efforts et voir ça, c’était comme une récompense.
             J’étais touché au plus profond de mon être. Faire une randonnée sur un volcan en Indonésie, ça a été la communion entre mon esprit et la nature.
				...
				<div class="progress-table-wrap">
					<div class="progress-table">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/arabs.jpg.png" alt="flag">Arabie saoudite</div>
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/qatar.png" alt="flag">Qatar</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/jordan.png" alt="flag">Jordanie</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/japon.png" alt="flag">Japon</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/indoesia.jpg" alt="flag">Indonesie</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/turquie.png" alt="flag">Turquie</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/kaza.jpg" alt="flag">Kirghizistan</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="img/elements/coree.png" alt="flag">Coree du Sud</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
				...
				<div class="row gallery-item">
					...
					<div class="col-md-4">
						<a href="img/elements/g2.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(img/elements/12.jpg);"></div>
						</a>
					</div>
					<div class="col-md-4">
						<a href="img/elements/g3.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(img/elements/9.jpg);"></div>
						</a>
					</div>
					<div class="col-md-6">
						<a href="img/elements/g4.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(img/elements/8.jpg);"></div>
						</a>
					</div>
					<div class="col-md-6">
