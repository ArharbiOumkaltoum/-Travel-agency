...
<body>
  ...
  <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Payement avec réduction</h2>
                    </div>
                    <div class="col-lg-8">
                      <h3>${message}</h3>
                             ...
                             <div class="col-12">
                                <div class="col-12">
                                    <div class="form-group">
                                         <input class="form-control valid" name="numC"   type="text"  id="myInput" onfocus="this.placeholder = ''" onblur="this.placeholder = 'numéro de carte Bancaire '" placeholder="numéro de carte Bancaire" required>
                                    </div>
                                </div>
                                 
                                 <div class="col-12">
                                    <div class="form-group">
                                         <input class="form-control valid" name="codeP"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'code de promotion'" placeholder="code de promotion" required>
                                    </div>
                                          <div id="message">
							  <h3>il faut saisir au moins 8 numéro</h3>
							  <p id="number" class="invalid">8 numéro au minimum</p>
                        </div>
                                </div>
                                
                            <div class="form-group mt-3">
                                <input class="boxed-btn4 " name="login"  type="submit"  value="Acheter">
                            </div>
                            <div><a href="achat.jsp"><I>Payement Normal</I></a></div>
                          </div>
                        </form>
  <!-- ------------ -->
...
myInput.onkeyup = function() {
  ...
  // Validate numbers
  var numbers = /[0-9]/g;
  if(myInput.value.match(numbers) && myInput.value.length >= 8) {
