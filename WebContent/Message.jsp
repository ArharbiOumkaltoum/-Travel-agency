...
<body>
    ...
    <!-- header-end -->
     ...
     <!-- bradcam_area  -->
     <div class="bradcam_area bradcam_bg_16">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text text-center">
                        <h3>Contactez-nous</h3>
                        <p>Merci de tout cœur! Nous sommes contents de recevoir votre Message. </p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-8">
                        <form  action="MessageProcess" method="post">
                            ...
                            <div class="form-group mt-3">
                                <input class="boxed-btn4 "  name="login" type="submit"  value="envoyer">
                            </div>
                        </form>
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                ...
                                <p>Immeuble 44,quartier salam <br> sekteur 1 Rue Zarktoni </p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                            <div class="media-body">
                                <h3>+212 652 296 122/+212 658 686 254</h3>
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>Contact_friends@gmail.com</h3>
