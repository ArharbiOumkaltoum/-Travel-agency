...
<body>
    ...
    <header>
      ...
      <!-- bradcam_area  -->
     <div class="bradcam_area bradcam_bg_22">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text text-center">
                        <h3>Ready! Pour lire les niveaux messages</</h3>
                        <p></p>
                    </div>
                </div>
            </div>
...
<%
String id = request.getParameter("email_clt");
...
<h2 align="center"><font><strong>Messages :</strong></font></h2>
...
<tr bgcolor="#DEB887">
		...
		<td><%=resultSet.getString("email_clt") %></td>
		<td><%=resultSet.getString("commentaire") %></td>
