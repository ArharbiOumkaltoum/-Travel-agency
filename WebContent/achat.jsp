...
<body>
  ...
  <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Payement Normal</h2>
                    </div>
                    <div class="col-lg-8">
                    <from action="ContactProcess" >
                            <div class="row">
                             <div class="col-12">
                                <div class="col-12">
                                    <div class="form-group">
                                         <input class="form-control valid" name="numC"   type="text" id="myInput" onfocus="this.placeholder = ''" onblur="this.placeholder = 'numéro de carte Bancaire '" placeholder="numéro de carte Bancaire" pattern="(?=.*[A-Z]).{8,}" title="Must contain at least 8 numbers" required>
                                    </div>
                                    <div id="message">
                            ...
                            <div class="form-group mt-3">
                                <a href="bienAcheter.jsp">
                                <input class="boxed-btn4 " name="login"  type="submit"  value="Acheter"></a>
                            </div>
                            </form>
                          </div>
  <!-- ------------ -->
