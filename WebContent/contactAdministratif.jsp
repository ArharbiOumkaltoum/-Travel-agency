...
<body>
 ...
 <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">S'IDENTIFIER</h2>
                    </div>
                    <div class="col-lg-8">
                        <form  action="AdminProcess" method="get"  novalidate="novalidate">
                            <div class="row">
                             <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control valid" name="Utilisateur" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Utilisateur'" placeholder="Utilisateur" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                         <input class="form-control valid" name="Mdp" type="Password" onfocus="this.placeholder = ''" onblur="this.placeholder = '***********'" placeholder="***********" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mt-3">
                              <input class="boxed-btn4 " name="sub" type="submit"  value="login" >
                            </div>
                        </form>
