...
<body>
    ...
    <!-- bradcam_area  -->
    <div class="bradcam_area bradcam_bg_17">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="img/blog/a1.jpg" alt="">
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" >
                                    <h2>Quesque Un Voyage Thématique?</h2>
                                </a>
                                <p>Les voyages thématiques sont des voyages effectuer selon un thème particulier.

<br>Voyager n’est pas forcément synonyme de farniente pour tout le monde, les raisons qui poussent aux voyages sont nombreuses et parfois insolites. Il est également important de différencier le voyage des vacances, en effet un voyage peut s’effectuer dans le cadre professionnel, dans un but humanitaire ou pour des raisons de santé et d’hygiène. Ici retrouvez l’intégralité des voyages à thèmes, que vous soyez passionné de l’espace, Fjords en Norvège ou tout simplement du shopping !</p>
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="fa fa-user"></i> Voyage Thématique</a></li>
                                    <li><a href="#"><i class="fa fa-comments"></i> 22 Commentaires</a></li>
                                </ul>
                            </div>
                        </article>
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="img/blog/a2.jpg" alt="">
                                <a href="#" class="blog_item_date">
                                    <h3>15</h3>
                                    <p>Avril</p>
                                </a>
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" >
                                    <h2>Quels sont les avantages de nos voyages thématiques ?</h2>
                                </a>
                                <p>Pour aborder ce qui vous passionne, il faut prendre du temps, et pour améliorer la qualité des séjours, finalement découvrir une destination passe par la connaissance de ceux qui y vivent.</p>
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="fa fa-user"></i> Voyage Thématique</a></li>
                                    <li><a href="#"><i class="fa fa-comments"></i> 08 Commentaires</a></li>
                                </ul>
                            </div>
                        </article>
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="img/blog/a4.jpg" alt="">
                                <a href="#" class="blog_item_date">
                                    <h3>06</h3>
                                    <p>Avril</p>
                                </a>
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block">
                                    <h2>A qui s’adresse le concept de Thematique ?</h2>
                                </a>
                                <p>A ceux qui connaissent et aiment le voyage.<br>
A ceux qui s’intéressent à un thème particulier.<br>
A ceux qui veulent voyager différemment.</p>
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="fa fa-user"></i> Voyage Thématique</a></li>
                                    <li><a href="#"><i class="fa fa-comments"></i>96 Commentaires</a></li>
                                </ul>
                            </div>
                        </article>
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="img/blog/a3.jpg" alt="">
                                <a href="#" class="blog_item_date">
                                    <h3>27</h3>
                                    <p>Novembre</p>
                                </a>
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block">
                                    <h2>A travers plusieurs grandes thématiques, nous vous proposons des expériences riches dans de nombreuses régions d'Asie et du monde.</h2>
                                </a>
                                
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="fa fa-user"></i> Voyage Thématique</a></li>
                                    <li><a href="#"><i class="fa fa-comments"></i>90 Commentaires</a></li>
                                </ul>
                            </div>
                        </article>
                    ...
                    <div class="blog_right_sidebar">
                        <aside class="single_sidebar_widget instagram_feeds">
                            ...
                            <ul class="instagram_row flex-wrap">
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="img/post/f3.jpg" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="img/post/f9.jpg" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                ...
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="img/post/mc.jpg" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                ...
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="img/post/post_2.png" alt="">
                                    </a>
                                </li>
                            </ul>
                        </aside>
