...
<body>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text text-center">
                        <h3>Ready!! pour ajouter une promotion</h3>
                        <p></p>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Ajouter une promotion</h2>
                    </div>
                    <div class="col-lg-8">
                        <form  action="Promotion" method="post">
                            <div class="row">
                             <div class="col-12">
                                 <div><h3>${confirmationP}</h3></div>
                                    <div class="form-group">
                                        <input class="form-control valid" name="idP"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Entrer id de promotion'" placeholder=" Entrer id de promotion" required>
                                    </div>
                                </div>
                            ...
                            <div class="form-group mt-3">
                                <input class="boxed-btn4 " name="login"  type="submit"  value="ajouterPro">
                            </div>
                        </form>
