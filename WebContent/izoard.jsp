            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-9">
                    <div class="destination_info">
                        <h3>Description</h3>
                        <p> 
                       Partons à la découverte d'une des plus belles vallées du massif du Briançonnais. Une vallée empreinte d'histoire, de traditions, où l'architecture dévoile les conditions de vie d'antan... Calme, beauté du lieu et des itinéraires seront au rendez-vous. Un week-end allongé idéal pour découvrir cette région sauvage et chaleureuse.
                       
                        </p>	
					<div class="single_destination">
                            <h4>Jour-01</h4>
                            <p>  Accueil - première initiation au ski de randonnée<br/>
Accueil à la gare et transfert pour la station de Montgenèvre, à cheval entre France et Italie. Cette journée est consacrée à la mise en jambes, aux formations techniques et à l'apprentissage de l'utilisation du matériel de sécurité. Dans l'après-midi, si les conditions le permettent, nous descendrons à ski sur Cervières par un grand itinéraire hors-piste jusqu'à notre hôtel. Les bagages seront acheminés sur place.
Pique-nique le midi, dîner et nuit au gîte.<br></p>
                        </div>
                         <div class="single_destination">
                            <h4>Jour-02</h4>
                            <p>Chalets d'Izoard - col des Ourdeïs<br>
Petit déjeuner et balade qui nous amènera, à travers bois, jusqu'aux chalets d'Izoard (2190m), ancien hameau d'alpage situé dans un cirque minéral grandiose, au pied du fameux col. Puis, de là, nous gravirons les dernières pentes jusqu'au col des Ourdeïs (2420m), porte d'accès au parc naturel régional du Queyras.
</p> </div>
                       <div class="single_destination">
                            <h4>Jour-03</h4>
                            <p>Montée jusqu'à la cime de Saurel<br>
Petit déjeuner et sortie en ski de rando, à travers un terrain vallonné, à la frontière avec le Piémont italien. Nous gravirons la cime de Saurel (2451m) d'où nous aurons une vue spectaculaire sur la vallée des Fonts et ses nombreux hameaux, ainsi que toute la vallée de Sestrières. Il ne nous restera qu'à descendre pour terminer ce séjour en beauté. Nous reprenons les affaires au gîte et conduisons ceux qui prennent le train à la gare de Briançon ou d'Oulx.
</p>
                         </div>
