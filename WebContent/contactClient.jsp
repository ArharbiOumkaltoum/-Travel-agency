                        ...
                        <form  action="ContactProcess" method="post" >
                            <div class="row">
                             <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                         <input class="form-control valid" name="MotPass"  type="Password" onfocus="this.placeholder = ''" onblur="this.placeholder = '***********'" placeholder="***********" required>
                                    </div>
                                </div>
                            </div>
                      ...
                      <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            <div class="media-body">
                                <a href="Création.jsp"><h3> Créer Votre Espace Client</h3></a>
                            </div>
                      </div>
                    </div>
</div>
